...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.LedRun \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../LedRun.srcs/sources_1/bd/LedRun/ipshared/4868" \
       +incdir+"$ref_dir/../../../../LedRun.srcs/sources_1/bd/LedRun/ipshared/ec67/hdl" \
       +incdir+"../../../../LedRun.srcs/sources_1/bd/LedRun/ipshared/4868" \
       +incdir+"../../../../LedRun.srcs/sources_1/bd/LedRun/ipshared/ec67/hdl"
}
