...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_17 -L xil_defaultlib -L microblaze_v10_0_5 -L mdm_v3_2_12 -L proc_sys_reset_v5_0_12 -L xlconstant_v1_1_3 -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_15 -L fifo_generator_v13_2_1 -L axi_data_fifo_v2_1_14 -L axi_crossbar_v2_1_16 -L lmb_v10_v3_0_9 -L lmb_bram_if_cntlr_v4_0_14 -L blk_mem_gen_v8_4_1 -L lib_pkg_v1_0_2 -L lib_srl_fifo_v1_0_2 -L axi_uartlite_v2_0_19 -L lib_fifo_v1_0_10 -L axi_fifo_mm_s_v4_1_12 -L axi_iic_v2_0_18 -L axi_intc_v4_1_10 -L axi_hwicap_v3_0_19 -L xlconcat_v2_1_1 -L axi_timer_v2_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot LedRun xil_defaultlib.LedRun xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim LedRun -key {Behavioral:sim_1:Functional:LedRun} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb LedRun.wdb xsim.dir)
