...
HD_PWD='D:/01_Xilinx_FPGA/LedRun/LedRun.runs/LedRun_axi_hwicap_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LedRun_axi_hwicap_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LedRun_axi_hwicap_0_0.tcl
