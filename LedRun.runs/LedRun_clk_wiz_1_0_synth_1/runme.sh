...
HD_PWD='D:/01_Xilinx_FPGA/LedRun/LedRun.runs/LedRun_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LedRun_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LedRun_clk_wiz_1_0.tcl
