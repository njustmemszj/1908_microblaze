...
HD_PWD='D:/01_Xilinx_FPGA/LedRun/LedRun.runs/LedRun_lmb_bram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LedRun_lmb_bram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LedRun_lmb_bram_1.tcl
