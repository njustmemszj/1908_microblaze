...
HD_PWD='D:/01_Xilinx_FPGA/LedRun/LedRun.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LedRun_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LedRun_wrapper.tcl
