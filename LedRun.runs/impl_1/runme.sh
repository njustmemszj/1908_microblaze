...
HD_PWD='D:/01_Xilinx_FPGA/LedRun/LedRun.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LedRun_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LedRun_wrapper.tcl -notrace
